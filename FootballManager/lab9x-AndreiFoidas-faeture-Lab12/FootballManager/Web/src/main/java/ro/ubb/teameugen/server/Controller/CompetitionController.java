...
public class CompetitionController {
    ...
    public CompetitionsDto getAllCompetitions(@RequestParam(required = false) Boolean biggestPrizePool,
        ...
        logger.trace("[GET] /competitions - getAllCompetitions entered with parameters biggestPrizePool = {}, firstYear = {}, sortByFirstYear = {}, name = {}",
                biggestPrizePool, firstYear, sortByFirstYear, name);
        ...
        if (biggestPrizePool != null) {
            ...
            logger.trace("Parameters for #filterCompetitionByName(name)");
            competitionService.filterCompetitionByName(name).forEach(competition -> competitions.add(competitionConverter.convertModelToDto(competition)));
        } else {
