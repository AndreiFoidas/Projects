...
public class ClubService implements IClubService {
   ...
   /* public ClubService(ClubRepository clubRepository, BaseValidator<Club> clubBaseValidator){
        this.clubBaseValidator=clubBaseValidator;
    ...
    public Iterable<Club> getClubs() {
        ...
        var result=clubRepository.findAllClubs();
    ...
    public List<Club> filterClubsByOwner(String ownerName) {
        ...
        var result =clubRepository.findAllClubsByOwnerName(ownerName);
    ...
    public List<Club> filterClubsByCountry(String country) {
        ...
        var result = clubRepository.findClubsByCountry(country);
    ...
    public List<Club> sortClubsByName(){
        ...
        var result = clubRepository.sortClubsByName();
